...
import com.itech4kids.wingsoffire.Commands.*;
...
public class Main extends JavaPlugin {
    ...
    public void onEnable(){
        ...
        registerEntity("JMANPC", 118, EntityVillagerTrader.class);
        loadRecipe();
    }
    ...
    public void openShapeShiftGui(Player player){
        ...
        ItemMeta itemMeta = space1.getItemMeta();
        itemMeta.setDisplayName(" ");
        shapeshiftInventory.addItem(space1);

        ItemStack skull = new ItemStack(Material.PLAYER_HEAD);
        SkullMeta skullMeta = (SkullMeta) skull.getItemMeta();
        List<String> lore = new ArrayList<>();
        skullMeta.setDisplayName(ChatColor.WHITE + "IceWings");
        IDtoSkull(skull, "");
        lore.add(" ");
        lore.add(ChatColor.YELLOW + "Click to select!");

        lore.clear();
        skullMeta.setDisplayName(ChatColor.BLACK + "NightWings");
        IDtoSkull(skull, "");
        lore.add(" ");
        lore.add(ChatColor.YELLOW + "Click to select!");
    }
    ...
    public void openSelectNumber(Player player){
        selectNumber.clear();

        ItemStack up = new ItemStack(Material.GREEN_CONCRETE);
        ItemMeta upMeta = up.getItemMeta();
        upMeta.setDisplayName(ChatColor.GREEN + "Select 1");
        up.setItemMeta(upMeta);
        selectNumber.addItem(up);
        upMeta.setDisplayName(ChatColor.GREEN + "Select 2");
        up.setItemMeta(upMeta);
        selectNumber.addItem(up);
        upMeta.setDisplayName(ChatColor.GREEN + "Select 3");
        up.setItemMeta(upMeta);
        selectNumber.addItem(up);
        upMeta.setDisplayName(ChatColor.GREEN + "Select 4");
        up.setItemMeta(upMeta);
        selectNumber.addItem(up);
        upMeta.setDisplayName(ChatColor.GREEN + "Select 5");
        up.setItemMeta(upMeta);
        selectNumber.addItem(up);
        ItemStack space1 = new ItemStack(Material.GRAY_STAINED_GLASS_PANE, 1);
        ItemMeta itemMeta = space1.getItemMeta();
        itemMeta.setDisplayName(" ");
        space1.setItemMeta(itemMeta);
        selectNumber.addItem(space1);
        selectNumber.setItem(6, space1);
        selectNumber.setItem(7, space1);
        selectNumber.setItem(8, space1);

        player.openInventory(selectNumber);
    }
    ...
    public void openTalismanEnchantingInventory(Player player){
        ...
        bookLore.add(ChatColor.GRAY + "armor piece or enchanted");
        ...
        protBookLore.add(ChatColor.GRAY + "sword or enchanted book!");
    ...
    public void openPlayerEnchantsGui(Player player){
        ...
        itemMeta.setDisplayName(ChatColor.GREEN + "Species Shift");
    ...
    public void startStudy(Player player){
        if (!getActivePlayer(player.getName()).upgrade){
            if (Config.getAnimusStudyLevel(player) < 4) {
                ...
                //(((Config.getAnimusStudyLevel(player)+1)*20)*60)*20
            }else{
            ...
            public void run() {
                if (!player.isOnline()) {
                    ...
                    if (Config.isAnimus(player)){
                        ...
                        PacketPlayOutTitle packet = new PacketPlayOutTitle(PacketPlayOutTitle.EnumTitleAction.ACTIONBAR, IChatBaseComponent.ChatSerializer.a(
                                "{\"text\":\"" + "§bAnimus Mana: " + Config.getMana(player) + "✯" + "\"}"), 1, Integer.MAX_VALUE, 1);
